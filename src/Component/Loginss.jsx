...
const Loginss = () => {
    ...
    return (
        <div className="relative font-sans">
            {/* Sticky Top Bar */}
            <div className="sticky top-0 z-50 bg-gray-100 px-4 py-3 flex flex-col sm:flex-row sm:justify-end items-center gap-2 sm:gap-6 text-white text-sm font-medium shadow-md">
                <button
