...
function Hero() {
    return (
      ...
      <div className="container mx-auto  flex flex-col-reverse md:flex-row items-center justify-between mb-0 ">
        {/* Left Side */}
        <div className="text-center md:text-left max-w-2xl px- md:px-3 lg:px-25 py-12 md:py-20">
        ...
        {/* Right Side (Image) */}
        <div className="mt-8 md:mt-0 w-full max-w-sm sm:max-w-lg md:max-w-lg lg:max-w-xl px-2 mb-0">
          <img
            src={logo}
            alt="Team"
